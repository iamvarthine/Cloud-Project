...
public class AppServer {
     public static void main(String[] args) throws Exception {
        ...
        ArrayList<Matrix> plainText=st.readPlain("C:/Users/sweat/OneDrive/Desktop/MINI PROJECT/miniproject-main/miniProject/src/abc.txt");
        ...
        String strs=st.matrixToString(decryptedText);
        System.out.println("Decrypted "+strs.replace("%", "").replace("$", ""));
        System.exit(0);
